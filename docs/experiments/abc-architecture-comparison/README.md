...
- Claude: adversarial reviewer. Claude should challenge kernels, confound controls, thresholds, and interpretation.
- User: final sign-off on the roadmap after the 40 judged manuscripts and `conclusion.md` are complete.

Design sign-off:

- The experiment design is ready when codex and Claude both mark the ADR, README, kernels, and protocol as `AGREE`.
